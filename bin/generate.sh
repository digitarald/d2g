...
replace_zip()
{
  ...
  # bwalker I had to comment this out
  # rm -f $zip
  oldpwd=$PWD
...
# bwalker refactored sign_app_with_new_cert into create_cert_for_label and sign_app_with_cert_for_label

create_cert_for_label trusted   $srcdir/unsigned.zip $srcdir/valid.zip
# create_cert_for_label untrusted $srcdir/unsigned.zip $srcdir/unknown_issuer.zip

sign_app_with_cert_for_label trusted   $srcdir/unsigned.zip $srcdir/valid.zip
# sign_app_with_cert_for_label untrusted $srcdir/unsigned.zip $srcdir/unknown_issuer.zip
